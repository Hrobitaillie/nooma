...
- **Low effort assumé** : pas de topologie propre requise (on ne déforme pas ces meshes, sauf Plouma) — sculpt + remesh suffit pour les objets statiques.
...
### 4.1 Mascotte Plouma (la seule 3D « animée sérieusement »)
